<script setup>
import { BoText, BoFontSize, BoFontWeight, BoTextColor, BoTextAlign, BoFontFamily, BoTextWhiteSpace } from '@/components/bo-text';
</script>
...
<div class="space-y-2">
  ...
  />
  <bo-text 
    value="This is a paragraph of text that demonstrates how the BoText component can be used for standard content. It supports various text styles and formatting options." 
...
<div class="space-y-1">
  ...
  />
  <bo-input placeholder="Enter your email" />
</div>
```
...
<div class="rounded-lg border border-gray-200 p-4 shadow-sm">
  ...
  />
  <bo-text 
    value="Card subtitle with secondary color" 
    :size="BoFontSize.sm"
    :color="BoTextColor.secondary"
    class="mt-1 mb-4"
  />
  <bo-text 
    value="This is the main content of the card. The BoText component can be used throughout your UI to maintain consistent typography." 
  />
</div>
```
