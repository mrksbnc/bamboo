<template>
	...
	<svg
		v-else-if="name === Icon.alert_circle"
		xmlns="http://www.w3.org/2000/svg"
		:width="iconSize"
		:height="iconSize"
		viewBox="0 0 24 24"
	...
	<svg
		v-else-if="name === Icon.alert_octagon"
		xmlns="http://www.w3.org/2000/svg"
		:width="iconSize"
		:height="iconSize"
		viewBox="0 0 24 24"
	...
	<svg
		v-else-if="name === Icon.alert_triangle"
		xmlns="http://www.w3.org/2000/svg"
		:width="iconSize"
		:height="iconSize"
		viewBox="0 0 24 24"
	...
	<svg
		v-else-if="name === Icon.align_center"
		xmlns="http://www.w3.org/2000/svg"
		:width="iconSize"
		:height="iconSize"
		viewBox="0 0 24 24"
	...
	<svg
		v-else-if="name === Icon.align_justify"
		xmlns="http://www.w3.org/2000/svg"
		:width="iconSize"
		:height="iconSize"
		viewBox="0 0 24 24"
	...
	<svg
		v-else-if="name === Icon.align_left"
		xmlns="http://www.w3.org/2000/svg"
		:width="iconSize"
		:height="iconSize"
	...
	<svg
		v-else-if="name === Icon.align_right"
		xmlns="http://www.w3.org/2000/svg"
		:width="iconSize"
		:height="iconSize"
	...
	<svg
		v-else-if="name === Icon.arrow_down_circle"
		xmlns="http://www.w3.org/2000/svg"
		:width="iconSize"
		:height="iconSize"
	...
	<svg
		v-else-if="name === Icon.arrow_down_left"
		xmlns="http://www.w3.org/2000/svg"
		:width="iconSize"
		:height="iconSize"
	...
	<svg
		v-else-if="name === Icon.arrow_down_right"
		xmlns="http://www.w3.org/2000/svg"
		:width="iconSize"
		:height="iconSize"
	...
	<svg
		v-else-if="name === Icon.arrow_down"
		xmlns="http://www.w3.org/2000/svg"
		:width="iconSize"
		:height="iconSize"
	...
	<svg
		v-else-if="name === Icon.arrow_left_circle"
		xmlns="http://www.w3.org/2000/svg"
		:width="iconSize"
		:height="iconSize"
	...
	<svg
		v-else-if="name === Icon.arrow_left"
		xmlns="http://www.w3.org/2000/svg"
		:width="iconSize"
		:height="iconSize"
		...
		stroke-linejoin="round"
	>
		<polyline points="19 12 5 12 12 19"></polyline>
	</svg>
	<svg
		v-else-if="name === Icon.arrow_right_circle"
		xmlns="http://www.w3.org/2000/svg"
		:width="iconSize"
		:height="iconSize"
	...
	<svg
		v-else-if="name === Icon.arrow_right"
		xmlns="http://www.w3.org/2000/svg"
		:width="iconSize"
		:height="iconSize"
		...
		stroke-linejoin="round"
	>
		<polyline points="5 12 19 12 12 19"></polyline>
	</svg>
	<svg
		v-else-if="name === Icon.arrow_up_circle"
		xmlns="http://www.w3.org/2000/svg"
		:width="iconSize"
		:height="iconSize"
	...
	<svg
		v-else-if="name === Icon.arrow_up_left"
		xmlns="http://www.w3.org/2000/svg"
		:width="iconSize"
		:height="iconSize"
	...
	<svg
		v-else-if="name === Icon.arrow_up_right"
		xmlns="http://www.w3.org/2000/svg"
		:width="iconSize"
		:height="iconSize"
...
const props = defineProps({
	...
	strokeStyle: {
		...
		default: () => IconStrokeStyle.normal,
	},
});

const { name, size, color, strokeStyle } = toRefs(props);
...
const iconStrokeStyle = computed(() => {
	switch (strokeStyle.value) {
		case IconStrokeStyle.thin:
			return '1';
		case IconStrokeStyle.normal:
			return '2';
		case IconStrokeStyle.bold:
			return '3';
		default:
			return '2';
	}
...
const iconColor = computed(() => {
	return color.value ?? 'var(--icon-color)';
});
</script>
