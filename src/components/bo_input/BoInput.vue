  ...
  <div :class="defaultContainerClasses" class="relative">
    ...
    <span :class="inputContainer">
      <span v-if="prefixIcon != null" :class="defaultPrefixIconContainerClasses">
        <bo-icon :size="iconSize" :icon="prefixIcon" :color="BoColor.gray_500"
      /></span>
      <input
        v-bind="$attrs"
        :id="computedInputId"
      ...
      <div class="flex flex-row-reverse">
        <span v-if="suffixIcon != null" :class="defaultSuffixIconContainerClasses">
          <bo-icon :size="iconSize" :icon="suffixIcon" :color="BoColor.gray_500"
        /></span>
...
const loadingContainerClasses = computed<string>(() => {
  return TailwindUtils.merge(
    isLoading.value ? (suffixIcon.value != null ? 'right-[35px]' : 'right-[14px]') : '',
