...
export enum BoButtonLightShadowClasses {
	primary = /*tw*/ 'shadow-sm shadow-blue-600/10',
	secondary = /*tw*/ 'shadow-sm shadow-neutral-600/10',
	danger = /*tw*/ 'shadow-sm shadow-red-600/10',
	warning = /*tw*/ 'shadow-sm shadow-yellow-600/10',
	success = /*tw*/ 'shadow-sm shadow-green-600/10',
	dark = /*tw*/ 'shadow-sm shadow-black-600/10',
	light = /*tw*/ 'shadow-sm shadow-neutral-900/10',
	purple = /*tw*/ 'shadow-sm shadow-purple-600/10',
	teal = /*tw*/ 'shadow-sm shadow-teal-600/10',
}

export enum BoButtonDarkShadowClasses {
	primary = /*tw*/ 'dark:shadow-sm dark:shadow-blue-800/80',
	secondary = /*tw*/ 'dark:shadow-sm dark:shadow-neutral-800/80',
	danger = /*tw*/ 'dark:shadow-sm dark:shadow-red-800/80',
	warning = /*tw*/ 'dark:shadow-sm dark:shadow-yellow-800/80',
	success = /*tw*/ 'dark:shadow-sm dark:shadow-green-800/80',
	dark = /*tw*/ 'dark:shadow-sm dark:shadow-black-800/80',
	light = /*tw*/ 'dark:shadow-sm dark:shadow-neutral-900/80',
	purple = /*tw*/ 'dark:shadow-sm dark:shadow-purple-800/80',
	teal = /*tw*/ 'dark:shadow-sm dark:shadow-teal-800/80',
}

export enum BoButtonLightFilledColorClasses {
...
export enum BoButtonDarkFilledColorClasses {
	primary = /*tw*/ 'dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-600 dark:text-white',
	secondary = /*tw*/ 'dark:bg-neutral-100 dark:hover:bg-neutral-200 dark:focus:ring-neutral-100 dark:text-neutral-900',
	danger = /*tw*/ 'dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-600 dark:text-white',
	warning = /*tw*/ 'dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-600 dark:text-white',
	success = /*tw*/ 'dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-600 dark:text-white',
	...
	purple = /*tw*/ 'dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-600 dark:text-white',
	teal = /*tw*/ 'dark:bg-teal-600 dark:hover:bg-teal-700 dark:focus:ring-teal-600 dark:text-white',
}

export enum BoButtonLightOutlineColorClasses {
...
export enum BoButtonDarkOutlineColorClasses {
...
export enum BoButtonLightLinkTypeClasses {
	primary = /*tw*/ 'text-blue-600 hover:text-blue-700',
	secondary = /*tw*/ 'text-neutral-800 hover:text-neutral-600',
	danger = /*tw*/ 'text-red-600 hover:text-red-700',
	warning = /*tw*/ 'text-yellow-600 hover:text-yellow-700',
	success = /*tw*/ 'text-green-600 hover:text-green-700',
	dark = /*tw*/ 'text-black hover:text-black/50',
	light = /*tw*/ 'text-blue-400 hover:text-blue-500',
	purple = /*tw*/ 'text-purple-600 hover:text-purple-700',
	teal = /*tw*/ 'text-teal-600 hover:text-teal-700',
}

export enum BoButtonDarkLinkTypeClasses {
	primary = /*tw*/ 'dark:text-blue-600 dark:hover:text-blue-700',
	secondary = /*tw*/ 'dark:text-neutral-800 dark:hover:text-neutral-900',
	danger = /*tw*/ 'dark:text-red-600 dark:hover:text-red-700',
	warning = /*tw*/ 'dark:text-yellow-600 dark:hover:text-yellow-700',
	success = /*tw*/ 'dark:text-green-600 dark:hover:text-green-700',
	dark = /*tw*/ 'dark:text-black dark:hover:text-black/50',
	light = /*tw*/ 'dark:text-blue-400 dark:hover:text-blue-500',
	purple = /*tw*/ 'dark:text-purple-600 dark:hover:text-purple-700',
	teal = /*tw*/ 'dark:text-teal-600 dark:hover:text-teal-700',
}
