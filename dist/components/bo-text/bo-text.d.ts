...
export declare enum BoFontWeight {
    /** 100 */
    thin = "thin",
    /** 200 */
...
export declare enum BoFontSize {
    /** 12px */
    xs = "xs",
    /** 14px */
    sm = "sm",
...
export declare enum BoFontFamily {
    sans = "sans",
    mono = "mono",
    serif = "serif",
    inherit = "inherit"
}
export declare enum BoTextWhiteSpace {
    normal = "normal",
    nowrap = "nowrap",
    pre = "pre",
    pre_line = "pre-line",
...
export declare enum BoTextVariant {
    default = "default",
    primary = "primary",
    secondary = "secondary",
    disabled = "disabled",
...
export declare enum BoTextAlign {
    left = "left",
    center = "center",
    right = "right",
    justify = "justify"
}
export declare enum BoTextTransform {
    none = "none",
