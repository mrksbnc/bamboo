...
describe("BoText", () => {
  ...
  test("should apply correct classes for all text variants", () => {
    ...
    for (const variant of variants) {
      ...
      expect(wrapper.classes().join(" ").includes(`bo-text--${variant}`)).toBe(
        true,
      );
    }
  });
  ...
  test("should apply correct classes for all font sizes", () => {
    ...
    for (const size of sizes) {
      ...
      expect(
        wrapper.classes().join(" ").includes(`bo-text--size-${size}`),
      ).toBe(true);
    }
  });
  ...
  test("should apply correct classes for all font weights", () => {
    ...
    for (const weight of weights) {
      ...
      expect(
        wrapper.classes().join(" ").includes(`bo-text--weight-${weight}`),
      ).toBe(true);
    }
  });
  ...
  test("should apply correct classes for all font families", () => {
    ...
    for (const family of families) {
      ...
      expect(
        wrapper.classes().join(" ").includes(`bo-text--font-${family}`),
      ).toBe(true);
    }
  });
  ...
  test("should apply correct classes for all text alignments", () => {
    ...
    for (const alignment of alignments) {
      ...
      expect(
        wrapper.classes().join(" ").includes(`bo-text--align-${alignment}`),
      ).toBe(true);
    }
  });
  ...
  test("should apply correct classes for all text transforms", () => {
    ...
    for (const transform of transforms) {
      ...
      expect(
        wrapper.classes().join(" ").includes(`bo-text--transform-${transform}`),
      ).toBe(true);
    }
  });
    ...
    for (const whiteSpace of whiteSpaces) {
      ...
      expect(
        wrapper
          .classes()
          .join(" ")
          .includes(`bo-text--whitespace-${whiteSpace}`),
      ).toBe(true);
    }
  });
