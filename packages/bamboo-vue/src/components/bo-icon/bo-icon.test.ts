...
describe("bo-icon", () => {
  describe("rendering", () => {
    ...
    it("should render with data-testid", () => {
      ...
      expect(wrapper.find("i").attributes("data-testid")).toBe(
        "custom-test-id",
      );
    });
  ...
  describe("custom color", () => {
    it("should apply custom color when provided", () => {
      ...
      expect(ColorService.instance.getCustomColorStyle).toHaveBeenCalledWith(
        customColor,
      );
