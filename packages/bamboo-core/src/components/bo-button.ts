...
export type BoButtonSizeMap = Record<BoButtonSize, string>;

export type BoButtonType = 'button' | 'submit' | 'reset';
/**
...
export const BoButtonSizeStyle = {
...
} as const satisfies BoButtonSizeMap;
