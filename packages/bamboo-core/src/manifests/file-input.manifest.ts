...
export const FILE_INPUT_MANIFEST = {
	...
	styles: {
		...
		trigger: 'bo-file-input__trigger',
		triggerContent: 'bo-file-input__trigger-content',
		triggerTitle: 'bo-file-input__trigger-title',
		triggerHint: 'bo-file-input__trigger-hint',
		triggerAction: 'bo-file-input__trigger-action',
