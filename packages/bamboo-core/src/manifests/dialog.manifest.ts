...
export const DIALOG_MANIFEST = {
	...
	styles: {
		...
		panel: {
			...
			variant: {
				default: 'bo-dialog-panel--variant-default',
				info: 'bo-dialog-panel--variant-info',
				warning: 'bo-dialog-panel--variant-warning',
				destructive: 'bo-dialog-panel--variant-destructive',
			},
		},
