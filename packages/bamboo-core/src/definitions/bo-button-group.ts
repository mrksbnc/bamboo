...
export interface BoButtonGroupItemProps {
	/** The id of the button. Autogenerated if not provided. */
	id?: HTMLButtonElement['id'];
	/** The data test id of the button. Autogenerated if not provided. */
	dataTestId?: string;
	/** The value represented by the button. */
	value: string | number;
...
export interface BoButtonGroupStyleManifest {
	...
	size: Record<BoButtonSize, string>;
	variant: Record<BoButtonVariant, string>;
	fullWidth: string;
	attached: {
		base: string;
		orientation: BoButtonGroupOrientationStyleMap;
