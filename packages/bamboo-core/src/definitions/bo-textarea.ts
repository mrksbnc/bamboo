...
import { BoFontSize, Icon } from './index.js';
...
export interface BoTextareaProps {
	...
	expand?: boolean;
	/** Explicit CSS height. Numeric values are interpreted as pixels. */
	height?: number | string;
	/** Maximum CSS height. Numeric values are interpreted as pixels. */
	maxHeight?: number | string;
	/** The role of the element. */
	role?: HTMLAttributes['role'];
	/** Defines a string value that labels the current element. */
	ariaLabel?: HTMLAttributes['aria-label'];
	/** Identifies supporting text for the textarea. */
